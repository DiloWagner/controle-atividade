 ...
 */
class Bairro extends \EnderecoApi\Entity\Bairro implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EnderecoApi\\Entity\\Bairro' . "\0" . 'id', '' . "\0" . 'EnderecoApi\\Entity\\Bairro' . "\0" . 'cidade', '' . "\0" . 'EnderecoApi\\Entity\\Bairro' . "\0" . 'nome');
        }
