...
namespace DoctrineORMModule\Proxy\__CG__\EnderecoApi\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Cidade extends \EnderecoApi\Entity\Cidade implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EnderecoApi\\Entity\\Cidade' . "\0" . 'id', '' . "\0" . 'EnderecoApi\\Entity\\Cidade' . "\0" . 'nome', '' . "\0" . 'EnderecoApi\\Entity\\Cidade' . "\0" . 'uf');
        }
     ...
     * {@inheritDoc}
     */
    public function setUf(\EnderecoApi\Entity\Uf $uf = NULL)
    {
