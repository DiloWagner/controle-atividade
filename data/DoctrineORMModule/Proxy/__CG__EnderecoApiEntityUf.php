 ...
 */
class Uf extends \EnderecoApi\Entity\Uf implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EnderecoApi\\Entity\\Uf' . "\0" . 'id', '' . "\0" . 'EnderecoApi\\Entity\\Uf' . "\0" . 'nome', '' . "\0" . 'EnderecoApi\\Entity\\Uf' . "\0" . 'uf');
        }
